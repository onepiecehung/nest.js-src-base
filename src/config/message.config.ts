export const MESSAGE_CODE = {
  ...
  USER_HAS_BEEN_BLOCKED_OR_DELETED: 1047,
  EMAIL_HAS_NOT_REGISTERED: 1048,
  EMAIL_HAS_REGISTERED: 1049,
  PHONE_NUMBER_HAS_REGISTERED: 1050,
  USERNAME_IS_ALREADY_USED: 1051,
  ...
  // TODO: Challenge
  CHALLENGE_NOT_FOUND: 2200,

  // TODO: OTP
  OTP_SEND_TOO_FAST: 2300,
  OTP_HAS_EXPIRED: 2301,
  OTP_INCORRECT: 2302,
...
export const MESSAGE_TEXT = {
  ...
  [MESSAGE_CODE.PASSWORD_INCORRECT]: `The password is incorrect`,
  ...
  [MESSAGE_CODE.USER_HAS_BEEN_BLOCKED_OR_DELETED]: `User has been deleted or blocked`,
  [MESSAGE_CODE.EMAIL_HAS_NOT_REGISTERED]: `Your email has not registered`,
  [MESSAGE_CODE.EMAIL_HAS_REGISTERED]: `Your email has already registered`,
  [MESSAGE_CODE.PHONE_NUMBER_HAS_REGISTERED]: `Phone number has already registered`,
  [MESSAGE_CODE.USERNAME_IS_ALREADY_USED]: `Username is already used`,
  ...
  [MESSAGE_CODE.PET_BREED_NOT_FOUND]: `Pet breed not found`,
  ...
  // TODO: Challenge
  [MESSAGE_CODE.CHALLENGE_NOT_FOUND]: `Challenge not found`,

  // TODO: OTP
  [MESSAGE_CODE.OTP_SEND_TOO_FAST]: `OTP sends too fast`,
  [MESSAGE_CODE.OTP_HAS_EXPIRED]: `OTP has expired`,
  [MESSAGE_CODE.OTP_INCORRECT]: `Wrong code enter! Please try again`,

  // TODO: BMG
  [MESSAGE_CODE.BMG_NOT_FOUND]: `BMG not found`,
};
